...
/**
 * Behat exapdf-related steps definitions.
 *
...
/**
 * Steps definitions related with the exapdf.
 *
 * @package    assignfeedback_exapdf
 * @category   test
 * @copyright  2013 Jerome Mouneyrac
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_assignfeedback_exapdf extends behat_base {
    ...
    public function ghostscript_is_installed() {
        $testpath = assignfeedback_exapdf\pdf::test_gs_path();
        if (!extension_loaded('zlib') or
            $testpath->status !== assignfeedback_exapdf\pdf::GSPATH_OK) {
    ...
    public function i_draw_on_the_pdf() {
        $js = ' (function() {
    var instance = M.assignfeedback_exapdf.instance;
     ...
     */
    public function i_wait_for_all_exapdf_pages_to_load() {
        ...
        $conditions = [
            'typeof M !== "undefined"',
            'typeof M.assignfeedback_exapdf !== "undefined"',
            'typeof M.assignfeedback_exapdf.instance !== "undefined"',
            'M.assignfeedback_exapdf.instance.documentstatus === 2',
            'M.assignfeedback_exapdf.instance.pagecount === M.assignfeedback_exapdf.instance.pages.length',
        ];
